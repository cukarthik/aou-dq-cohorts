...
outputFolder <- "s:/aoudqcohorts/mydb"
cdmDatabaseSchema <- "CDM_mydb_V1247.dbo"
cohortDatabaseSchema <- "mydb.dbo"
cohortTable <- "aoudqcohorts_mydatabase"
databaseId <- "mydb"
...
aoudqcohorts::runCohortDiagnostics(connectionDetails = connectionDetails,
